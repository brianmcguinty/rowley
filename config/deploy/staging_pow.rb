set :application, 'mr_powers'
set :rails_env, "staging"
set :branch, "develop"
set :user, "qsuser"
set :domain, "qsuser@powstaging.quartsoft.com" # Это необходимо для деплоя через ssh. Именно ради этого я настоятельно советовал сразу же залить на сервер свой ключ, чтобы не вводить паролей.
